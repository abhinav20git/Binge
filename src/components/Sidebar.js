...
const Sidebar = () => {
  ...
  return (
    <div className='p-2 shadow-lg w-48 h-full'>
      <div className="flex justify-between max-w-24 p-2 h-8">
        <img className="h-6 mr-4 " src="https://tse4.mm.bing.net/th?id=OIP.GcRlpNTMNf06GOD3l3pILgHaHa&pid=Api&P=0&h=180"/>
        
        <h2 className=' font-bold'> Home</h2>
      </div>
      <div className='flex justify-between max-w-36 p-2  mt-2'>
         <img className="h-6 " src="https://tse4.mm.bing.net/th?id=OIP.fDwmo1JR2X-RLM_tmhNs5gHaHa&pid=Api&P=0&h=180"/>
      ...
      <div className='flex justify-between max-w-24 p-2 h-8'>
        <img className="h-6 mr-4" src="https://tse4.mm.bing.net/th?id=OIP.ALQ_AhTcTkO4wes5Yg5AegHaHa&pid=Api&P=0&h=180"/>
